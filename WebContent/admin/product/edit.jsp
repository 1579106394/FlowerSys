...
<body>
	...
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/flower/editFlower.html"
		method="post">
		<input type="hidden" name="flwId" value="${flower.flwId }">

		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>编辑花卉</STRONG> </strong></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="flwName" value="${flower.flwName }"
					id="userAction_save_do_logonName" class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					花卉价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="flwPrice" value="${flower.flwPrice }"
					id="userAction_save_do_logonName" class="bg" /></td>
			</tr>
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					花卉数量：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="flwNum" value="${flower.flwNum }"
					id="userAction_save_do_logonName" class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					花卉品种：</td>
